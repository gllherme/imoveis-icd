...
#Variaveis fixas
vPagFinal = 999         #Numero total de paginas a serem buscadas, se houver menos o script controla
...
vImovelLista = ["casas-de-vila", "apartamentos", "coberturas", "quitenetes", "casas-de-condominio", "casas", "flat", "studio"]   #"casas","casas-de-vila","casas-de-condominio"
...
vValorMin = 150      #Valor Minimo
vValorMax = 950000     #Valor Maximo
        ...
        for vBairro in vBairroLista:
            ...
            for vImovel in vImovelLista:
                ...
                if vBairro == 'TODOS':
                    if vZona == 'TODOS':
                        if vCidade == 'TODOS':
                            vURL_B = "https://www.zapimoveis.com.br/" + vTransacao + "/imoveis"
                        else:
                            vURL_B = "https://www.zapimoveis.com.br/" + vTransacao + "/imoveis/" + vUF + "+" + vCidade
                    else:
                        vURL_B = "https://www.zapimoveis.com.br/" + vTransacao + "/imoveis/" + vUF + "+" + vCidade + "+" + vZona
                else:
                    vURL_B = "https://www.zapimoveis.com.br/" + vTransacao + "/imoveis/" + vUF + "+" + vCidade + "+" + vZona + "+" + vBairro
                ...
                while vPagina <= vPagFinal:
                    ...
                    #URL
                    vURL = vURL_B + "/?pagina=" + str(vPagina) + "&precoMinimo=" + str(vValorMin) + "&precoMaximo=" + str(vValorMax) + "&tipoAluguel=Mensal"
                    ...
                    if vStat == 200:
                        ...
                        if vValPag == 'NOK':
                            ...
                            vCol = ['listing.nonActivationReason','listing.providerId','listing.address.stateAcronym','listing.address.source',
                                    ...
                                    'listing.address.poisList','listing.address.pois','listing.address.valuableZones',
                                    ...
                                    'listing.pricingInfo.businessDescription']   #,'listing.address.complement'
                            '''
                ...
                df_Zap.to_csv('./data_to_join/dataZAP_'+vTransacao+'_'+vImovel+'_'+vBairro+'.csv', sep=';', index=False)
                print('\nArquivo criado\n')
                print('-----------------------------------------------------')
